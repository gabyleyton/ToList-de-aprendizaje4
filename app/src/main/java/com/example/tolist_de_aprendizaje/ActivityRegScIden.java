...
public class ActivityRegScIden extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reg_sc_iden);
        ...
        buttonRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for (int i = 0; i < editTexts.size(); i++) {
                    ...
                    if (!text.isEmpty()) { // Solo procesar si no está vacío
                        ...
                        try {
                            ...
                            Toast.makeText(ActivityRegScIden.this,
                ...
                Toast.makeText(ActivityRegScIden.this,
                        "Porcentajes registrados: " + percentages,
                        Toast.LENGTH_SHORT).show();
            }
        });
    }
